...
// @Produce json
// @Security Bearer
// @Param tags body user_dtos.Code true "Verify Change Email Code"
...
// @Router /users/verifyChangeEmailCode/{find} [post]
func VerifyChangeEmailCode(c *gin.Context) {
	...
	useCase := &user_usecases.VerifyChangeEmailCode{UserRepository: userRepository}
